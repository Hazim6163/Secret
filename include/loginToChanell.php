    ...
    <div class="row h-100 justify-content-center " style="padding-top: 10vh">
        <div class="col-12  col-lg-6 col-xl-4">
            ...
            <form action="index2.php" method="post" autocomplete="off">
             <input type="hidden" name="password" value=<?php echo $secret_chanell;?></inpu>
              <div class="form-group">
                <label for="username">Username</label>
                <input type="text" autocomplete="off" class="form-control" name="username" aria-describedby="usernameHelp" placeholder="Enter your Username" style="background-color: #36282B; border:0px; color:#d6d4d4">
                <small id="usernameHelp" class="form-text " style="color: #954242; ">It will be your Name in the chat...</small>
                <label for="username">Password</label>
                <input type="password" autocomplete="off" class="form-control" name="password"  placeholder="Enter your Password" style="background-color: #36282B; border:0px; color:#d6d4d4">
              </div>
